...
#include "wecook/LowLevelMotionNodes/FakeMotionNode.h"

using namespace wecook;

void FakeMotionNode::plan(const std::shared_ptr<ada::Ada> &ada, const std::shared_ptr<ada::Ada> &adaImg, Result *result) {
