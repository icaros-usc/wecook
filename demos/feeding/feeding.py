...
PDDL_DOMAIN_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "domain.pddl")
PDDL_PROBLEM_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "problem.pddl")
